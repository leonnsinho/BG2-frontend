      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4 mb-6 sm:mb-8">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl sm:rounded-2xl p-3 sm:p-4 shadow-sm border border-gray-100 dark:border-gray-700">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2">
              <div className="flex-1 min-w-0">
                <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 mb-1 truncate">Empresas</p>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl sm:rounded-2xl p-3 sm:p-4 shadow-sm border border-green-100 dark:border-green-900/40 col-span-2 sm:col-span-1">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2">
              <div className="flex-1 min-w-0">
                <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 mb-1 truncate">Média de Conclusão</p>
        ...
        {/* Filtros */}
        <div className="bg-white dark:bg-gray-800 rounded-xl sm:rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-4 sm:p-5 mb-4 sm:mb-6">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-9 sm:pl-10 pr-4 py-2.5 sm:py-3 min-h-[44px] text-sm sm:text-base rounded-xl border border-gray-200 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 focus:outline-none focus:border-[#EBA500] transition-colors"
            />
          </div>
        </div>
        ...
        {filteredRequests.length === 0 ? (
          ...
          <div className="space-y-3 sm:space-y-4">
            {filteredRequests.map((request) => (
              <div
                key={request.id}
                className="bg-white dark:bg-gray-800 rounded-xl sm:rounded-2xl shadow-sm border-2 border-gray-100 dark:border-gray-700 overflow-hidden hover:shadow-md hover:border-amber-200 transition-all"
              >
                {/* Accent bar */}
                ...
                <div className="p-4 sm:p-5 lg:p-6">
                  ...
                  <div className="flex flex-col sm:flex-row items-start justify-between gap-3 mb-4">
                    <div className="flex items-start gap-3 flex-1 min-w-0">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 mt-0.5">{request.journey_name}</p>
                  ...
                  <div className="grid grid-cols-3 gap-3 mb-4">
                    ...
                    <div className="bg-gray-50 dark:bg-gray-700 rounded-xl p-3 border border-gray-100 dark:border-gray-600 col-span-2 sm:col-span-1">
                      <div className="flex items-center gap-1.5 mb-1">
                        <User className="h-3 w-3 text-gray-400" />
                        <span className="text-xs font-semibold text-gray-500 dark:text-gray-400">Solicitado por</span>
                      </div>
                      <div className="text-xs sm:text-sm font-semibold text-gray-900 dark:text-white truncate">
                        {request.requester_name || 'N/A'}
                      </div>
                      <div className="text-xs text-gray-400 dark:text-gray-500 truncate">{request.requester_email}</div>
                    </div>

                    <div className="bg-gray-50 dark:bg-gray-700 rounded-xl p-3 border border-gray-100 dark:border-gray-600 col-span-3 sm:col-span-1">
                      <div className="flex items-center gap-1.5 mb-1">
                        <Calendar className="h-3 w-3 text-gray-400" />
                        <span className="text-xs font-semibold text-gray-500 dark:text-gray-400">Data da Solicitação</span>
                      </div>
                  ...
                  {request.gestor_notes && (
                    <div className="bg-gray-50 dark:bg-gray-700 rounded-xl p-3 border border-gray-100 dark:border-gray-600 mb-4">
                      <div className="flex items-center gap-1.5 mb-1.5">
                        <MessageSquare className="h-3 w-3 text-gray-400" />
                        <span className="text-xs font-semibold text-gray-700 dark:text-gray-300">Observações do Gestor</span>
                      </div>
                  ...
                  <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 pt-4 border-t border-gray-100 dark:border-gray-700">
                    <div className="flex items-center gap-1.5 text-xs sm:text-sm text-gray-500 dark:text-gray-400">
                      ...
                      <span className="truncate">
                        <span className="font-semibold text-gray-700 dark:text-gray-200">{request.company_name}</span>
                      </span>
                    </div>
                    ...
                    <div className="flex items-center gap-2 w-full sm:w-auto">
                      <button
                        ...
                        className="flex-1 sm:flex-none flex items-center justify-center gap-2 px-4 py-2.5 bg-white dark:bg-gray-700 border-2 border-red-200 dark:border-red-700 text-red-600 dark:text-red-400 rounded-xl hover:bg-red-50 dark:hover:bg-red-900/20 hover:border-red-300 font-semibold transition-all disabled:opacity-50 text-sm min-h-[44px]"
                      >
        ...
        {showApproveModal && selectedRequest && (
          <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-3 sm:p-4">
            <div className="bg-white dark:bg-gray-800 rounded-2xl max-w-lg w-full shadow-2xl max-h-[95vh] overflow-y-auto">
              <div className="p-4 sm:p-6 border-b border-gray-100 dark:border-gray-700">
                <h3 className="text-lg sm:text-xl font-bold text-gray-900 dark:text-white">Confirmar Amadurecimento</h3>
                <p className="text-sm text-gray-500 dark:text-gray-400 mt-0.5">Revise antes de confirmar</p>
              </div>
              ...
              <div className="p-4 sm:p-6 space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={3}
                    className="w-full px-4 py-3 border border-gray-200 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 rounded-xl focus:outline-none focus:border-[#EBA500] focus:ring-2 focus:ring-amber-500/20 transition-all resize-none text-sm"
                  />
                </div>
              </div>

              <div className="p-4 sm:p-6 border-t border-gray-100 dark:border-gray-700 flex flex-col-reverse sm:flex-row justify-end gap-2 sm:gap-3">
                <button
                  onClick={() => { setShowApproveModal(false); setSelectedRequest(null) }}
                  className="px-5 py-2.5 text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-600 font-medium transition-all text-sm min-h-[44px]"
                >
                  Cancelar
                </button>
                <button
        ...
        {showRejectModal && selectedRequest && (
          <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-3 sm:p-4">
            <div className="bg-white dark:bg-gray-800 rounded-2xl max-w-lg w-full shadow-2xl max-h-[95vh] overflow-y-auto">
              <div className="p-4 sm:p-6 border-b border-gray-100 dark:border-gray-700">
                <h3 className="text-lg sm:text-xl font-bold text-gray-900 dark:text-white">Rejeitar Solicitação</h3>
                <p className="text-sm text-gray-500 dark:text-gray-400 mt-0.5">O gestor será notificado com o motivo</p>
              </div>
