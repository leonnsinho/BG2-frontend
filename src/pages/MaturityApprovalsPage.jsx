...
const MaturityApprovalsPage = () => {
  ...
  return (
    <div className="space-y-8">
      {/* Header */}
      <div className="bg-gradient-to-r from-white to-green-50 border-b border-gray-200/50 shadow-sm -mx-8 -mt-8 px-8 py-8">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-[#373435] mb-1">
      ...
      {requests.length === 0 ? (
        ...
        <div className="space-y-6">
          {requests.map((request) => (
            <div 
              key={request.id}
              className="bg-white rounded-3xl shadow-sm border border-gray-200/50 overflow-hidden hover:shadow-md transition-all"
            >
              {/* Header do Card */}
              <div className="bg-gradient-to-r from-green-50 to-blue-50 p-6 border-b border-gray-200">
                <div className="flex items-start justify-between">
                  ...
                  <div className="text-right">
                    <div className="inline-flex items-center px-3 py-1.5 bg-yellow-100 text-yellow-800 rounded-full text-xs font-semibold border border-yellow-200">
              ...
              <div className="p-6">
                ...
                <div className="flex items-center space-x-2 text-sm text-gray-600 mb-6">
                  ...
                  <span>Empresa: <span className="font-semibold text-gray-900">{request.company_name}</span></span>
                </div>
                ...
                <div className="flex items-center justify-end space-x-3 pt-4 border-t border-gray-200">
                  <button
                    ...
                    className="flex items-center space-x-2 px-6 py-2.5 bg-white border-2 border-red-300 text-red-600 rounded-xl hover:bg-red-50 font-semibold transition-all disabled:opacity-50"
                  >
                  ...
                  <button
                    ...
                    disabled={actionLoading === request.id}
                    className="flex items-center space-x-2 px-6 py-2.5 bg-gradient-to-r from-green-500 to-green-600 text-white rounded-xl hover:from-green-600 hover:to-green-700 font-semibold transition-all shadow-md hover:shadow-lg disabled:opacity-50"
                  >
                    {actionLoading === request.id ? (
                      ...
                      <>
                        ...
                        <span>Aprovar Amadurecimento</span>
                      </>
                    )}
                  </button>
                </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-3xl max-w-lg w-full shadow-2xl">
            <div className="p-6 border-b border-gray-200">
              <h3 className="text-xl font-bold text-gray-900">Confirmar Amadurecimento</h3>
            </div>
            ...
            <div className="p-6 space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-green-500/30 focus:border-green-500 transition-all resize-none text-sm"
                />
              </div>
            </div>
            ...
            <div className="p-6 border-t border-gray-200 flex justify-end space-x-3">
              <button
                ...
                className="px-6 py-2.5 text-gray-700 bg-white border border-gray-300 rounded-xl hover:bg-gray-50 font-medium transition-all"
              >
                Cancelar
              </button>
              <button
                ...
                className="flex items-center space-x-2 px-6 py-2.5 bg-gradient-to-r from-green-500 to-green-600 text-white rounded-xl hover:from-green-600 hover:to-green-700 font-semibold transition-all shadow-md disabled:opacity-50"
              >
      ...
      {showRejectModal && selectedRequest && (
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-3xl max-w-lg w-full shadow-2xl">
            <div className="p-6 border-b border-gray-200">
              <h3 className="text-xl font-bold text-gray-900">Rejeitar Solicitação</h3>
            </div>
            ...
            <div className="p-6 space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={4}
                  required
                  className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-red-500/30 focus:border-red-500 transition-all resize-none text-sm"
                />
              </div>
            </div>
            ...
            <div className="p-6 border-t border-gray-200 flex justify-end space-x-3">
              ...
              <button
                ...
                className="flex items-center space-x-2 px-6 py-2.5 bg-gradient-to-r from-red-500 to-red-600 text-white rounded-xl hover:from-red-600 hover:to-red-700 font-semibold transition-all shadow-md disabled:opacity-50"
              >
