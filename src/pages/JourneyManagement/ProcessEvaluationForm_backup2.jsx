  ...
  const handleSave = async () => {
    try {
      ...
      const dataToSave = {
        ...
        // Combinar evidence_files com paths dos arquivos enviados
        evidence_files: [
      ...
      // Remover o campo uploaded_files antes de salvar (só usado no frontend)
      delete dataToSave.uploaded_files

      console.log('🔄 Dados para salvar:', dataToSave)
      console.log('🔄 Usuario atual:', profile)
      console.log('🔄 Empresa ID:', companyId)
      console.log('🔄 Processo ID:', processId)

      let result
      if (evaluation) {
        // Atualizar avaliação existente
        console.log('📝 Atualizando avaliação existente ID:', evaluation.id)
